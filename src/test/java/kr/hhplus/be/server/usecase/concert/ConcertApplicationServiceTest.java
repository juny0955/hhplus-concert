...
class ConcertApplicationServiceTest {
	...
	void getAvailableConcertDates_Success() throws CustomException {
		...
		List<ConcertDate> results = concertApplicationService.getAvailableConcertDates(concertId);
	...
	void getAvailableConcertDates_Failure_ConcertNotFound() {
		...
		CustomException customException = assertThrows(CustomException.class,
			() -> concertApplicationService.getAvailableConcertDates(concertId));
	...
	void getAvailableSeats_Success() throws CustomException {
		...
		List<Seat> results = concertApplicationService.getAvailableSeats(concertId, concertDateId);
	...
	void getAvailableSeats_Failure_ConcertNotFound() {
		...
		CustomException customException = assertThrows(CustomException.class,
			() -> concertApplicationService.getAvailableSeats(concertId, concertDateId));
