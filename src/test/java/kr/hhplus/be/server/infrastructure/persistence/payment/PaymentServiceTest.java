...
import kr.hhplus.be.server.application.seatHold.port.out.SeatHoldRepository;
...
class PaymentServiceTest {
	...
	void processPayment_Success() throws CustomException {
		...
		PaymentTransactionResult result = paymentService.processPayment(paymentCommand, queueToken);
	...
	void processPayment_Failure_ReservationNotFound() throws CustomException {
		...
		CustomException exception = assertThrows(CustomException.class,
			() -> paymentService.processPayment(paymentCommand, queueToken));
