...
public class QueueController {
	...
	public ResponseEntity<QueueTokenResponse> issueQueueToken(
		...
		QueueToken queueToken = issueQueueTokenUseCase.issueQueueToken(userId, concertId);
	...
	public ResponseEntity<QueueTokenResponse> getQueueInfo(
		...
		QueueToken result = getQueueTokenUseCase.getQueueTokenInfo(concertId, queueToken);
