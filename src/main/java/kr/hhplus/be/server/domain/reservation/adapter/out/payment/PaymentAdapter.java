package kr.hhplus.be.server.domain.reservation.adapter.out.payment;
...
import kr.hhplus.be.server.domain.reservation.port.out.CreatePaymentPort;
...
public class PaymentAdapter implements CreatePaymentPort, CancelPaymentPort {
